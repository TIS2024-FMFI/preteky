...
class Mod_get():
    def __init__(self, api_endpoint: str, api_key: str):
        ...
        self.date_converter = DateConverter.DateConverter()
    ...
    def get_races_in_month(self, month):
        ...
        param = {"date_from": {self.date_converter.return_date_with_first_day_of_month(month)},
                 "date_to": {self.date_converter.return_date_with_last_day_of_month(month)}}
    ...
    def get_races_from_date(self):
        url = f'{self._api_endpoint}/competitions'
        param = {"date_from": {self.date_converter.get_realtime_date()}}
        response = requests.get(url, headers=self._get_header(), params=param)
        self._handle_response_code(response)
        return response.json()
